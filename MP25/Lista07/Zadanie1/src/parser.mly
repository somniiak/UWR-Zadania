...
mexpr:
    ...
    | FOLD; e1 = mexpr; WITH; LPAREN; x = IDENT; COMMA; acc = IDENT; RPAREN; ARR; e2 = mexpr; ANDWORD; e3 = mexpr { Fold(e1, x, acc, e2, e3) }
    | e = expr { e }
    ;
...
expr:
    ...
    | LBRACK; lst = separated_list(SEMICOLON, expr); RBRACK
        { List.fold_right (fun e acc -> Pair(e, acc)) lst Unit }
    ;
